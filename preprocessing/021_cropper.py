...
LoadMasksForCrop = str(train_val_gauss_masks).replace('preprocessing/', '') + '/'

SaveCropImages = str(cropped_train_val_gauss_images).replace('preprocessing/', '') + '/'
SaveCropMasks = str(cropped_train_val_gauss_masks).replace('preprocessing/', '') + '/'
