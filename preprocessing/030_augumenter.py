...
if __name__ == "__main__":
    ...
    parser.add_argument('--images_path', nargs="?", default=cropped_train_val_gauss_images,
                        help='the folder including the images to crop')
    parser.add_argument('--masks_path', nargs="?", default=cropped_train_val_gauss_masks, help='the folder including the masks to crop')
    parser.add_argument('--saved_images_path', nargs="?", default=aug_cropped_train_val_gauss_images, help='save images path')
    parser.add_argument('--saved_masks_path', nargs="?", default=aug_cropped_train_val_gauss_masks, help='save masks path')
