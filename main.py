...
def train(args):
    ...
    print('LEARNING RATE USED:',args.lr)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--patience', nargs="?", type=int, default=5, help='patience for early stopping')
...
#--few_shot --fine_tuning --lr 0.0001 --model_name c-resunet_y_11 --unfreezed_layers 5 --new_model_name c-resunet_y_11_dec_bottl_fs_20  --few_shot_samples 20 --few_shot_random_seed 10
#--few_shot --lr 0.001  --model_name c-resunet_g_lr001_fs_20  --few_shot_samples 20 --few_shot_random_seed 234

#next to do:
#--fine_tuning  --unfreezed_layers 20 --model_name c-resunet_y_11 --new_model_name c-resunet_y_11_full

#--fine_tuning  --unfreezed_layers -1 --model_name c-resunet_y_11 --new_model_name c-resunet_y_11_last_layer
#--fine_tuning  --unfreezed_layers 0 6 --model_name c-resunet_y_11 --new_model_name c-resunet_y_11_encoder

#--fine_tuning  --unfreezed_layers 1 1 colorspace conv_block bottleneck 1 --model_name c-resunet_y_11 --new_model_name c-resunet_y_11_1_bottle_last
#--fine_tuning  --unfreezed_layers 1 1 2 2 colorspace conv_block bottleneck 1 --model_name c-resunet_y_11 --new_model_name c-resunet_y_11_2_bottle_last
